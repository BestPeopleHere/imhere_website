...
class EditWindow extends VisualObject {
    constructor() {
        ...
        this.genderInput = new NameInput();
    ...
    render() {
        return (
            <div className={styles['main-container']}>
                ...
                <Element instance={this.birthdayInput} className={styles['rectangle-1']}/>

                <span className={styles.name}>Пол</span>
                <Element instance={this.genderInput} className={styles['rectangle-1']}/>
                ...
                <Element instance={this.about} className={styles['rectangle-5']}/>
